...
handlers.index = (data, callback) => {
    ...
    if (data.method === 'get') {
        ...
        let templateData = {
            ...
            'head.description': 'We offer free, simple uptime monitoring for HTTP/HTTPS sites of all kind',
                        ...
                        if (userChecks.length < config.maxChecks) {
                            ...
                            _data.create('checks', checkId, checkObject, (err) => {
                                if (!err) {
                                    ...
                                    callback(400, {'Error' : 'The hostname of the URL entered did not resolve to any DNS entry'})
                                }
                            })
